...
See [Policy Configuration](/policy/overview) for complete field descriptions and [Computing Measurements](/policy/computing-measurements) for computing bootchain measurements.
...
See [Protocol Specification](/protocol/tls-handshake) for detailed protocol flow and security features.
